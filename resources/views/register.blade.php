    ...
    <form class="" action="/register" method="POST">
        ...
        <div class="max-w-sm mx-auto flex flex-col gap-6 p-4 ">
            ...
            <div class="">
                ...
                <p class="font-semibold text-[#1A2E6D]">Sign Up to continue</p>
            </div>
            ...
            <div class="flex flex-col gap-2 rounded-md border bg-[#EEEDFF] px-4 py-2 outline-none ring-[#1A2E6D] focus-within:ring-1 hover:ring-1">
                ...
                <div class="flex gap-1">
                    ...
                    <input name="nama" class="w-full bg-[#EEEDFF] px-2 outline-none" type="text" placeholder="Nama" required  />
                </div>
            </div>
            ...
            <input class="bg-[#1A2E6D] rounded-md py-2 text-slate-200 cursor-pointer hover:ring-2 ring-[#1A2E6D] outline-none" type="submit" value="REGISTER">

            <p class="text-center text-sm">Already have an <span class="font-semibold">OTODO</span> Account ? <a class="text-[#1A2E6D] font-semibold" href="/login">SIGN IN</a></p>
